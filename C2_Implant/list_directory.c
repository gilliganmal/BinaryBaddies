...
// CREDIT: https://github.com/bats3c/shad0w/blob/master/beacon/lib/stdlib/listdirs.c#L4
...
char* listdirs(char* Dir)
{
    ...
    if (INVALID_HANDLE_VALUE == hFind) 
    {
        ...
        sprintf(oBuffer, "ERROR: listing '%s' code: %ld.\n", szDir, GetLastError());
        return oBuffer;
    }
    ...
    {
        sprintf(oBuffer, "%sERROR: listing '%s' code: %ld.\n", oBuffer, szDir, dwError);
    }
